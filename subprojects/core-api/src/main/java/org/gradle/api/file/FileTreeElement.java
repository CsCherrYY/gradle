...
public interface FileTreeElement {
     ...
     * For details see {@link ReadOnlyFileAccessPermissions}.
     *
     * @since 8.2
     */
    @Incubating
    Provider<ReadOnlyFileAccessPermissions> getReadOnlyPermissions(); //TODO: terrible name, but Provider<ReadOnlyFileAccessPermissions> is not compatible with Property<FileAccessPermissions>
}
