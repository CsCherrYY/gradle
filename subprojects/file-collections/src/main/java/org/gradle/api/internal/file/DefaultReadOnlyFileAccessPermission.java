...
public class DefaultReadOnlyFileAccessPermission extends AbstractReadOnlyFileAccessPermission {

    private final Provider<Boolean> read;
    private final Provider<Boolean> write;
    private final Provider<Boolean> execute;

    public DefaultReadOnlyFileAccessPermission(int unixNumeric) {
